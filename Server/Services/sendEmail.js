...
const apiToRedirectEmail = `${process.env.BASE_URL_CLIENT_DOMAIN}/api/v1/auth/verifyEmail?token=`;
const apiToRedirectFotgotPassword = `${process.env.BASE_URL_CLIENT}/auth/resetPassword?token=`;
const apiToRedirectNewEmail = `${process.env.BASE_URL_CLIENT_DOMAIN}/api/v1/auth/verifyNewEmail?token=`;
...
module.exports = { sendRegistrationEmail, sendForgotPasswordEmail, sendNewEmail };
