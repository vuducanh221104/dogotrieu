...
export const IconEmailVerify: React.FC<IconsType> = ({ width = '16px', height = '16px', className, style }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const IconAuthWarning: React.FC<IconsType> = ({ width = '16px', height = '16px', className, style }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const IconAuthSuccess: React.FC<IconsType> = ({ width = '16px', height = '16px', className, style }) => (
    <svg
        className={className}
        style={style}
        width={width}
