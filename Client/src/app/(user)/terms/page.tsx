...
export async function generateMetadata(): Promise<Metadata> {
    const title = 'Điều Khoản Sử Dụng | Đồ Gỗ Triệu';
    const description = `Điều khoản sử dụng của Đồ Gỗ Triệu - Quy định và điều kiện khi sử dụng website và dịch vụ của chúng tôi. Vui lòng đọc kỹ các điều khoản trước khi sử dụng.`;
    const image =
    ...
    return {
        ...
        openGraph: {
            ...
            description: description,
            type: 'website',
            url: `${routes.domain.name}/terms`,
            images: [{ url: image, alt: 'Điều Khoản Sử Dụng | DOGOTRIEU', width: 1200, height: 630 }],
                ...
                <div className={cx('content')}>
                    ...
                    <div className={cx('section')}>
                        <p>
                            ...
                            use of the Đồ Gỗ Triệu website ("Website" or "Service") and any of its related products and
                            services (collectively, "Services"). This Agreement is legally binding between you ("User",
                            "you" or "your") and this Service operator ("Operator", "we", "us" or "our").
                        </p>
                        <p>
                            By accessing and using the Website and Services, you acknowledge that you have read,
                            understood, and agree to be bound by the terms of this Agreement. If you are entering into
                            this Agreement on behalf of a business or other legal entity, you represent that you have
                        ...
                        <p>
                            ...
                            you must not accept this Agreement and may not access and use the Website and Services. You
                            acknowledge that this Agreement is a contract between you and the Operator, even though it
                            is electronic and is not physically signed by you, and it governs your use of the Website
                            and Services.
                        </p>
                    </div>
                    ...
                    <div className={cx('section')}>
                        ...
                        <p>
                            ...
                            and any other actions taken in connection with it.
                        </p>
                        <p>
                            We may, but have no obligation to, monitor and review new accounts before you may sign in
                            and start using the Services. Providing false contact information of any kind may result in
                            the termination of your account.
                        </p>
                        <p>
                            You must immediately notify us of any unauthorized uses of your account or any other
                            breaches of security. We will not be liable for any acts or omissions by you, including any
                        ...
                        <p>
                            ...
                            you have violated any provision of this Agreement or that your conduct or content would tend
                            to damage our reputation and goodwill. If we delete your account for the foregoing reasons,
                            you may not re-register for our Services. We may block your email address and Internet
                            protocol address to prevent further registration.
                        </p>
                    </div>

                    <div className={cx('section')}>
                        <h2 className={cx('sub-heading')}>Links to other resources</h2>
                        <p>
                        ...
                        <p>
                            ...
                            responsibility or liability for the actions, products, services, and content of any other
                            third parties.
                        </p>
                        <p>
                            You should carefully review the legal statements and other conditions of use of any resource
                            which you access through a link on the Website and Services. Your linking to any other
                    ...
                    <div className={cx('section')}>
                        ...
                        <p>
                            ...
                            Website and Services or Content:
                        </p>
                        ...
                        <p>
                            We reserve the right to terminate your use of the Website and Services for violating any of
                            the prohibited uses.
                        </p>
                    </div>
                    ...
                    <div className={cx('section')}>
                        <h2 className={cx('sub-heading')}>Indemnification</h2>
                        <p>
                    ...
                    <div className={cx('section')}>
                        <h2 className={cx('sub-heading')}>Severability</h2>
                        <p>
                        ...
                        <p>
                            If any provision or portion of any provision of this Agreement shall be held to be illegal,
                            invalid or unenforceable by a court of competent jurisdiction, it is the intention of the
                            parties that the remaining provisions or portions thereof shall constitute their agreement
                    ...
                    <div className={cx('section')}>
                        <h2 className={cx('sub-heading')}>Dispute resolution</h2>
                        <p>
                            The formation, interpretation, and performance of this Agreement and any disputes arising
                            out of it shall be governed by the substantive and procedural laws of Vietnam without regard
                            to its rules on conflicts or choice of law and, to the extent applicable, the laws of
                            Vietnam.
                        </p>
                        <p>
                            The exclusive jurisdiction and venue for actions related to the subject matter hereof shall
                            be the courts located in Vietnam, and you hereby submit to the personal jurisdiction of such
                    ...
                    <div className={cx('section')}>
                        ...
                        <p>
                            ...
                            use of the Website and Services after any such changes shall constitute your consent to such
                            changes.
                        </p>
                    </div>

                    <div className={cx('section')}>
                        <h2 className={cx('sub-heading')}>Acceptance of these terms</h2>
                        <p>
                    ...
                    <div className={cx('footer-section')}>
                        <div className={cx('section')}>
                            ...
                            <p>This Agreement was last modified on 08/03/2024</p>
                        </div>
                        ...
                        <div className={cx('section')}>
                            ...
                            <p>
                                ...
                                contact us concerning any matter relating to it, you may contact us using the
                                information below:
                            </p>
