                        ...
                        <div className={cx('chat-content')}>
                            <div className={cx('minichat-social')}>
                                <ul className={cx('minichat-social-list')}>
                                    ...
                                    <li className={cx('minichat-social-item')}>
                                        <a
                                            href="http://m.me/minhtuanmobilesg"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        >
                                            <div className={cx('minichat-icon')}>
                    ...
                    <div className={cx('messsage-inner')}>
                        <button className={cx('button')} onClick={() => setOnShow(!onShow)}>
                            <div className={cx('icon-message-wrapper', onShow && 'active')}>
                                <MessageChat className={cx('icon')} />
                            </div>
                            <div className={cx('icon-message-wrapper', !onShow && 'active')}>
                                <MessageChatXmark className={cx('icon')} />
                            </div>
                        </button>
                    </div>
                </div>
